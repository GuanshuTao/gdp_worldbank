...
sort_gdp_edu_table <- gdp_edu_table[order(xxx$mean_gdp),] 
...
#### List of countries are Lower middle income but among the 38 nations with highest GDP  are : __`r  high_rank_lower_middle_income$Long.Name`__     
